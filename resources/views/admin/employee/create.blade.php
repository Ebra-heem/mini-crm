...
<div class="pd-20 card-box mb-30">
    <div class="wizard-content">
        <form class="tab-wizard wizard-circle wizard clearfix" action="{{ route('employees.store') }}" method="POST"
            role="application" id="steps-uid-0">
            @csrf
            <div class="content clearfix">
                <h5 id="steps-uid-0-h-0" tabindex="-1" class="title current">Create Employee Information</h5>
